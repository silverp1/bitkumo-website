...
Fortunately for you as a consumer many hosting providers are returning to an _a la carte_ model that allows you to make the choice to buy support or not. While pricing may not be set as a flat fee, _a la carte_ plans can still be very easy to understand. Ultimately, buying what you need (and nothing more) will keep more money in your pocket and will increase the likelihood you'll end up with great support when you need it.
